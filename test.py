...
#urlStr = "/sf-express/959194122622"
...
#urlStr = ""
#requestData = "{\"tracking_number\": \"959194122622\",\"carrier_code\":\"sf-express\",\"destination_code\":\"US\",\"tracking_ship_date\": \"20180908\",\"tracking_postal_code\":\"12201\",\"specialNumberDestination\":\"UK\",\"order\":\"#123\",\"order_create_time\":\"2018/09/08 16:51\",\"lang\":\"en\"}"
#result = tracker.trackingmore(requestData, urlStr, "realtime")

#10 Modify courier code(修改运输商)
#urlStr = ""
#requestData = "{\"tracking_number\": \"959194122622\",\"carrier_code\":\"sf-express\",\"update_carrier_code\":\"china-ems\"}"
...
#urlStr = ""
#requestData = "[{\"tracking_number\":\"959194122622\",\"carrier_code\":\"sf-express\"},{\"tracking_number\":\"LZ448865302CN\",\"carrier_code\":\"sf-express\"}]"
...
#urlStr = ""
#requestData = "[{\"carrier_code\":\"sf-express\",\"destination\":\"US\",\"original\":\"CN\"},{\"carrier_code\":\"china-ems\",\"destination\":\"US\",\"original\":\"CN\"}]"
#result = tracker.trackingmore(requestData, urlStr, "costtime")

#16 Delete multiple tracking item(批量删除)
#urlStr = ""
#requestData = "[{\"tracking_number\":\"959194122622\",\"carrier_code\":\"sf-express\"},{\"tracking_number\":\"LZ448865302CN\",\"carrier_code\":\"china-ems\"}]"
